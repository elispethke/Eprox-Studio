import BrowserFrame from "@/shared/components/ui/BrowserFrame";
import CardGlassWrapper from "@/features/projects/components/CardGlassWrapper";
import type { ProjectCardVariant, SystemProject } from "@/features/projects/types";

interface ProjectCardSystemProps {
  project: SystemProject;
  className?: string;
  variant?: ProjectCardVariant;
}

export default function ProjectCardSystem({
  project,
  className,
  variant = "carousel",
}: ProjectCardSystemProps) {
  if (variant === "grid") {
    return (
